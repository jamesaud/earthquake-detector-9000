...
class mnist_three_component(nn.Module):
    ...
    DIM = 32
    NOISE_RGB_AMOUNT = 4  # Centered around this value, How much to change the value of a color [Guassian distribution added to a grayscale color value [0-255]
    BLUR = 2
    F_DIM = 32
...
class mnist_three_component_kernel(nn.Module):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.feats = nn.Sequential(
            nn.Conv2d(3, 32, (2, 4), 1, 1),
            nn.MaxPool2d(2, 2),
            nn.ReLU(True),
            nn.BatchNorm2d(32),

            nn.Conv2d(32, 64, (2, 4), 1, 1),
            nn.ReLU(True),
            nn.BatchNorm2d(64),
